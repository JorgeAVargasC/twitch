...
export default function Navlinks () {
  ...
  const activeLink = (path) => {
    ...
    if (location.pathname === path) {
      return (`${baseStyle} border-white text-white md:border-purple-500 md:text-purple-500`)
    } else {
      return (`${baseStyle} border-slate-500 text-slate-500 hover:text-white duration-200 md:hover:border-purple-500 md:hover:text-purple-500`)
    }
  }
